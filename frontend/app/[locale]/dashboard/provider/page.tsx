...
import {
  ...
  ChevronRight, ArrowUpRight, Calendar, GraduationCap, FileSignature, Wallet,
} from "lucide-react";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: 1100 }}>
      <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}
        style={{ borderRadius: 18, padding: "2rem 2.5rem", minHeight: 168, position: "relative", overflow: "hidden", background: "linear-gradient(135deg, #1d3461 0%, #1e40af 55%, #2563eb 100%)" }}>
